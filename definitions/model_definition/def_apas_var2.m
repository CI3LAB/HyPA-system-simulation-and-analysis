model_def.robotName = 'APAS_var2'; % adopts large (realistic) scale (size and mass) but wider spreaded steering shaft cable attachment (compared to var0) and wider spreaded hoisting motor position (compared to var0)
% robot name, a string
...
% % cable attachment point definition
hoisting_cable_attachment_offset_x = accessory_size_scalar * 0.1;
hoisting_cable_attachment_offset_y = accessory_size_scalar * 0.1;
...
x_neg_shaft_cable_attachment = -0.8 * hoisting_frame_length_x / 2.0;
x_pos_shaft_cable_attachment = 0.8 * hoisting_frame_length_x / 2.0;
y_neg_shaft_cable_attachment = -0.8 * hoisting_frame_length_y / 2.0;
y_pos_shaft_cable_attachment = 0.8 * hoisting_frame_length_y / 2.0;
