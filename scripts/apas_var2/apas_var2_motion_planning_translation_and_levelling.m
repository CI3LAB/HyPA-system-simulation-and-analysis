...
if strcmp(mdl.robotName, 'APASR_var2')
    q0(10) = -0.15;
    q0(11) = 0.258;
    q0(12) = 0.363;
...
taskSpaceDescription_init = APASVar2TaskSpaceUpdate(mdl, q0, qdot0);
...
% var2 1.5*0.1 steering shaft cable attachment spread and 0.8 scaled hoisting cable motor placement
...
if ~bypass_stabilization_step
    ...
    for i = 1:stabilization_len
        ...
        i / stabilization_len
        taskSpaceDescription = APASVar2TaskSpaceUpdate(mdl, pose, vel);
...
for i = 1:len
    ...
    [steering_jnt, des_hoisting_cable_lengths, horizontal_trans, vertical_trans] = APASVar2StepModulePositionAndSteeringAngle(mdl, q0, des_module_pose);
