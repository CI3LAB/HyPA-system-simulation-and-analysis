...
if data_valid
    ...
    title('Translation Error (mm)', 'FontSize', title_font_size, 'FontName', font_name);
    figXLim = xlim;
    figYLim = ylim;
    figZLim = zlim;
    pbaspect([figXLim(2) - figXLim(1) figYLim(2) - figYLim(1) figZLim(2) - figZLim(1)]);
    view(scatter_view_angle);
    file_path = './data/analysis_result/apas_var1/workspace_analysis_res_translation_error';
    ...
    ylabel('Y (m)', 'FontSize', general_font_size, 'FontName', font_name);
    zlabel('Z (m)', 'FontSize', general_font_size, 'FontName', font_name);
    title('Horizontal Translation Error (mm)', 'FontSize', title_font_size, 'FontName', font_name);
    figXLim = xlim;
    figYLim = ylim;
    figZLim = zlim;
    pbaspect([figXLim(2) - figXLim(1) figYLim(2) - figYLim(1) figZLim(2) - figZLim(1)]);
    view(scatter_view_angle);
    file_path = './data/analysis_result/apas_var1/workspace_analysis_res_horizontal_translation_error';
    fig2pdf(fh, file_path);
    ...
    ylabel('Y (m)', 'FontSize', general_font_size, 'FontName', font_name);
    zlabel('Z (m)', 'FontSize', general_font_size, 'FontName', font_name);
    title('Vertical Translation Error (mm)', 'FontSize', title_font_size, 'FontName', font_name);
    figXLim = xlim;
    figYLim = ylim;
    figZLim = zlim;
    pbaspect([figXLim(2) - figXLim(1) figYLim(2) - figYLim(1) figZLim(2) - figZLim(1)]);
    view(scatter_view_angle);
    file_path = './data/analysis_result/apas_var1/workspace_analysis_res_vertical_translation_error';
    fig2pdf(fh, file_path);
    ...
    ylabel('Y (m)', 'FontSize', general_font_size, 'FontName', font_name);
    zlabel('Z (m)', 'FontSize', general_font_size, 'FontName', font_name);
    title('Attitude Error (deg)', 'FontSize', title_font_size, 'FontName', font_name);
    figXLim = xlim;
    figYLim = ylim;
    figZLim = zlim;
    pbaspect([figXLim(2) - figXLim(1) figYLim(2) - figYLim(1) figZLim(2) - figZLim(1)]);
    view(scatter_view_angle);
    file_path = './data/analysis_result/apas_var1/workspace_analysis_res_attitude_error';
    fig2pdf(fh, file_path);
