function refTrajObj = GenerateAPASTrajectory(module_pose, t_move, t_hold, delta_t)
    ...
    horizontal_target = module_pose(1);
    vertical_target = module_pose(2);
    height_target = module_pose(3);
    steering_angle_target = module_pose(4);
