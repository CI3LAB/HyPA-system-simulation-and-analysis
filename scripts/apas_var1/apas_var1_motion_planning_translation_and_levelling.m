...
if strcmp(mdl.robotName, 'APASR_var1')
    q0(10) = -0.15;
    q0(11) = 0.258;
    q0(12) = 0.363;
...
taskSpaceDescription_init = APASVar1TaskSpaceUpdate(mdl, q0, qdot0);
...
if ~bypass_stabilization_step
    ...
    for i = 1:stabilization_len
        ...
        i / stabilization_len
        taskSpaceDescription = APASVar1TaskSpaceUpdate(mdl, pose, vel);
...
for i = 1:len
    ...
    [steering_jnt, des_hoisting_cable_lengths, horizontal_trans, vertical_trans] = APASVar1StepModulePositionAndSteeringAngle(mdl, q0, des_module_pose);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (m)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/hoisting_cable_error';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Force (N)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/hoisting_cable_forces';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (m)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/linear_jnt_error';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Force (N)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/linear_jnt_forces';
fig2pdf(fh, file_path);
...
file_path = './data/simulation_result/apas_var1/steering_jnt_error';
fig2pdf(fh, file_path);
...
file_path = './data/simulation_result/apas_var1/steering_jnt_torque';
fig2pdf(fh, file_path);
...
file_path = './data/simulation_result/apas_var1/thruster_damping_vel';
fig2pdf(fh, file_path);
...
xlim([0, time_vec(end)]);
% legend('T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8');
file_path = './data/simulation_result/apas_var1/thruster_damping_forces';
fig2pdf(fh, file_path);
...
file_path = './data/simulation_result/apas_var1/translation_ctrl_tracking';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (deg)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/steering_ctrl_tracking';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (m)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/translation_ctrl_error';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (deg)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/steering_ctrl_tracking_error';
fig2pdf(fh, file_path);
...
xlabel('Time (sec)', 'FontSize', general_font_size, 'FontName', font_name);
ylabel('Error (deg)', 'FontSize', general_font_size, 'FontName', font_name);
file_path = './data/simulation_result/apas_var1/leveling_err';
fig2pdf(fh, file_path);
